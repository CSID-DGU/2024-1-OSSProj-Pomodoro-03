    ...
    return (
      <>
        <Helmet>
          ...
          <meta
            property="og:title"
            content="자취인 전용 위치기반 커뮤니티 리본(LIVE: ON) 상품 진행 상태 변경 페이지"
          />
          <meta
        ...
        <h1 className="sr-only">LIVEON</h1>
          ...
          {data.status === '모집중' ? (
            <div className={`${styles.group} bg-primary-200 flex items-center`}>
              <figure className={styles.figure}>
                <img src={waiting} alt="모집중" aria-hidden="true" />
                <figcaption>
            ...
            <div className={`${styles.group} bg-map-200 flex items-center`}>
              <figure className={styles.figure}>
                <img src={proceeding} alt="쉐어중" aria-hidden="true" />
                <figcaption>
                  <h3 className={`${styles.title} text-map-500`}>쉐어중</h3>
                  <p className={styles.description}>쉐어가 시작되었어요.</p>
                </figcaption>
              </figure>
            ...
            <div className={`${styles.group} bg-line-100 flex items-center`}>
              <figure className={styles.figure}>
                <img src={complete} alt="쉐어종료" aria-hidden="true" />
                <figcaption>
                  <h3 className={`${styles.title} text-greenishgray-500`}>
                    쉐어종료
                  </h3>
                  <p className={styles.description}>쉐어가 완료되었어요.</p>
                </figcaption>
              </figure>
