  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          property="og:title"
          content="자취인 전용 위치기반 커뮤니티 리본(LIVE: ON) 방 만들기 페이지"
        />
        <meta
        ...
        <meta
          ...
          content="쉐어 상품을 확인할 수 있는 페이지입니다. 카테고리, 상품명, 상품 이미지, 상품 가격, 내용, 픽업 날짜, 상태, 생성자, 지불 방법, 픽업 위치 등을 입력하면 방이 생성됩니다."
        />
        <meta
          name="description"
          content="쉐어 상품을 확인할 수 있는 페이지입니다. 카테고리, 상품명, 상품 이미지, 상품 가격, 내용, 픽업 날짜, 상태, 생성자, 지불 방법, 픽업 위치 등을 입력하면 방이 생성됩니다."
