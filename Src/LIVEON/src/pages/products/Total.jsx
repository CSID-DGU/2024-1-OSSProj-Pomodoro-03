...
const filterTotalProducts = async () => {
...
function Total() {
  ...
  return (
    <>
      <Helmet>
        <title>LIVE:ON - 전체 쉐어</title>
        <meta charset="UTF-8" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <meta
          property="og:title"
          content="LIVE:ON 전체쉐어 상품 페이지"
        />
        <meta
        ...
        <meta property="og:url" content="https://r09m.vercel.app/total" />
        <meta
          property="og:description"
          content="전체쉐어 상품을 확인할 수 있는 페이지입니다. 카테고리, 상품명, 상세내용, 진행상태, 참여자 현황을 확인할 수 있습니다."
        />
        <meta
          name="description"
          content="전체쉐어 상품을 확인할 수 있는 페이지입니다. 카테고리, 상품명, 상세내용, 진행상태, 참여자 현황을 확인할 수 있습니다."
      ...
      <div className="bg-line-200 py-2">
        <div className="px-4">
          <Header />
          <h2 className="pageTitle">전체 쉐어</h2>
        </div>
        <ul>
          {data.map(
            ({
